...
# DO: 2. Create a class. Feel free to call it MyDelegate.
# Within that class you don't even need an __init__ constructor (an empty constructor comes for free)
class MyDelegate(object):

# DO: 3. Create a method named guess_response within MyDelegate.
...
def main():
    # DO: 4. Create a my_delegate object from your MyDelegate class
...
def guess(mqtt_client, number_to_guess_entry):
    ...
    # DO: 5. Uncomment the line of code below to make guesses with EV3.
...
def set_num_dice(mqtt_client, num_dice_entry):
    ...
    # DO: 6. Write the line of code necessary to implement this method based on the doc string's description.
    mqtt_client.send_message("set_number_of_dice", [int(num_dice_entry.get())])

# DO: 7. See if you can solve the mystery.  Based on the dice how can you solve Petals on a Rose?
