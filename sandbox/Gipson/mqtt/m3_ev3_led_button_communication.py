...
# DO: 2. Within the MyDelegate class below add the method, set_led, to receive messages as described above.
...
def main():
    ...
    # DO: 3. Create an instance of your delegate class and an MQTT client, passing in the delegate object.
