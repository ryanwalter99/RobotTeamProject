...
def main():
    # DO: 2. Set my_name and set team_member_name then try this program with that person.
    ...
    team_member_name = "james"  # Used to set the topic that you will *publish to*
    ...
    # DO: 3. Call over a TA or instructor to sign your team's checkoff sheet.
    #
