...
# T: 2. Create a class. Feel free to call it MyDelegate.
# Within that class you don't even need an __init__ constructor (an empty constructor comes for free)
class MyDelegate(object):


# : 3. Create a method named guess_response within MyDelegate.
...
def main():
    # : 4. Create a my_delegate object from your MyDelegate class
...
def guess(mqtt_client, number_to_guess_entry):
    ...
    # : 5. Uncomment the line of code below to make guesses with EV3.
...
# : 7. See if you can solve the mystery.  Based on the dice how can you solve Petals on a Rose?
