...
# : 2. On your computer right click on the libs folder in PyCharm, select Mark Directory as... Sources Root
...
# : 4. Formally test your work. When you think you have the problem complete run these tests:
#   500 dps 24 inches
#   500 dps -24 inches
...
def main():
    ...
    while True:
        ...
        robot.drive_inches_backward(inches_target, speed_deg_per_second)
